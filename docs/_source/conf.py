...
bibtex_bibfiles = ['theory.bib', 'tutorial.bib']
...
latex_documents = [
    (master_doc, 'dafi.tex', u'DAFI Documentation',
     [author], 'manual'),
]
...
man_pages = [
    (master_doc, 'dafi', u'DAFI Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dafi', u'DAFI Documentation',
     author, 'dafi', 'Data Assimilation and Field Inversion',
     'Miscellaneous'),
]
