...
Location: src/TurbulenceModels/turbulenceModels/RAS/kOmegaNNLinearTrain

\*---------------------------------------------------------------------------*/

#include "kOmegaNNLinearTrain.H"
#include "fvOptions.H"
#include "bound.H"
...
template<class BasicTurbulenceModel>
kOmegaNNLinearTrain<BasicTurbulenceModel>::kOmegaNNLinearTrain
(
...
template<class BasicTurbulenceModel>
bool kOmegaNNLinearTrain<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kOmegaNNLinearTrain<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
