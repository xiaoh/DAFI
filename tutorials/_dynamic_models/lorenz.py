...
class Model(PhysicsModel):
    ...
    def __init__(self, nsamples, t_interval, t_end, max_iterations,
        ...
        super(self.__class__, self).__init__(
            nsamples, t_interval, t_end, max_iterations, input_dict)
        ...
        # read input file
        with open(input_dict['input_file'], 'r') as f:
           input_dict = yaml.load(f, yaml.SafeLoader)
        dt_interval = input_dict['dt_interval']
        x_init_mean = input_dict['x_init_mean']
        y_init_mean = input_dict['y_init_mean']
        z_init_mean = input_dict['z_init_mean']
        rho_init_mean = input_dict['rho_init_mean']
        x_init_std = input_dict['x_init_std']
        y_init_std = input_dict['y_init_std']
        z_init_std = input_dict['z_init_std']
        rho_init_std = input_dict['rho_init_std']
        beta = input_dict['beta']
        sigma = input_dict['sigma']
        x_obs_rel_std = input_dict['x_obs_rel_std']
        z_obs_rel_std = input_dict['z_obs_rel_std']
        x_obs_abs_std = input_dict['x_obs_abs_std']
        z_obs_abs_std = input_dict['z_obs_abs_std']
        x_true = input_dict['x_true']
        y_true = input_dict['y_true']
        z_true = input_dict['z_true']
        rho_true = input_dict['rho_true']
        beta_true = input_dict['beta_true']
        sigma_true = input_dict['sigma_true']
